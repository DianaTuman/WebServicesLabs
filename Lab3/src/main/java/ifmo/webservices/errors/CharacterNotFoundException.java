...
public class CharacterNotFoundException extends Exception {
    ...
    public CharacterNotFoundException(String message, CharacterServiceFault fault) {
        super(message);
        this.fault = fault;
    }

    public CharacterNotFoundException(String message, CharacterServiceFault fault, Throwable cause) {
        super(message, cause);
        this.fault = fault;
    }
