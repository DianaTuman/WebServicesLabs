...
public class ServiceRegister {
    ...
    public void publish(String businessName, String serviceName, String endPoint) {
        try {
            BusinessEntity businessEntity = getBusinessEntity(businessName);
            ...
            service.getName().add(newName(serviceName));
    ...
    private BusinessEntity getBusinessEntity(String businessName) throws Exception {
    ...
    private BusinessEntity createBusinessEntity(String businessName) {
        ...
        Name newBusinessName = new Name();
        newBusinessName.setValue(businessName);
        businessEntity.getName().add(newBusinessName);
        return businessEntity;
    }

    private Name newName(String serviceName){
        Name result = new Name();
        result.setValue(serviceName);
        return result;
    }
