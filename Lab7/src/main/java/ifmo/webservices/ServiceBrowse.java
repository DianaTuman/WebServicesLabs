...
public class ServiceBrowse {
    ...
    private String descriptionListToString(List<Description> name) {
        StringBuilder sb = new StringBuilder();
        for (int i = 0; i < name.size(); i++) {
            sb.append(name.get(i).getValue()).append(" ");
        }
    ...
    public void printServiceDetail(BusinessService businessService) {
        if (businessService == null) {
            return;
        }

        System.out.println("Service Name " + nameListToString(businessService.getName()));
        ...
        System.out.println("Desc " + descriptionListToString(businessService.getDescription()));
        System.out.println("Cat bag " + categoryBagToString(businessService.getCategoryBag()));
